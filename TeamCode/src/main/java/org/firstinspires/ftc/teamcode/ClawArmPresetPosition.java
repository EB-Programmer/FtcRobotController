...
public class ClawArmPresetPosition {
    ...
    public static ClawArmPresetPosition HighBasketPreset() {
        return new ClawArmPresetPosition(ClawConstants.CLAW_BASKET_DROP_POSITION,
    ...
    public static ClawArmPresetPosition HighBasketBackDropPreset() {
        return new ClawArmPresetPosition(ClawConstants.CLAW_BACK_DROP_POSITION,
    ...
    public static ClawArmPresetPosition HighChamberBackHangPreset() {
        return new ClawArmPresetPosition(ClawConstants.CLAW_BACK_CHAMBER_HANG_POSITION,
