...
import static org.firstinspires.ftc.teamcode.IntakeMotorConstants.IntakeDirection.EJECT;
import static org.firstinspires.ftc.teamcode.IntakeMotorConstants.IntakeDirection.INTAKE;
...
import static org.firstinspires.ftc.teamcode.VerticalSlideConstants.VERT_HANG_SPECIMEN_SPEED;
...
public class EbTestFunctionality extends OpMode {
    ...
    private void executeRobotAction() {
        switch (robotAction) {
            case IDLE:
                if (slideVertRightMotor.getCurrentPosition() > VERT_PRE_EXCHANGE_HEIGHT ||
                        slideVertLeftMotor.getCurrentPosition() > VERT_PRE_EXCHANGE_HEIGHT) {
    ...
    private boolean hasHungSpecimen() {
        ...
        if (pos > VERT_SPECIMEN_DROP_DISTANCE) {
            motorPower = VERT_HANG_SPECIMEN_SPEED;
        }
